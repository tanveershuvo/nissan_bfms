				...
				<form  method="POST" >
					...
					<div class="row clearfix">
						...
						<div class="col-lg-3 col-md-10 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" name="from"  id="from" value="<?php if (isset($start)){ echo $start; }?>" class="form-control"  placeholder="From">
								</div>
							</div>
						</div>
						<div class="col-lg-3 col-md-10 col-sm-8 col-xs-7">
							<div class="form-group">
								<div class="form-line">
									<input type="text" name="to"  id="to" value="<?php if (isset($end)){ echo $end; }?>" class="form-control"  placeholder="To">
								</div>
							</div>
						</div>
					</div>
